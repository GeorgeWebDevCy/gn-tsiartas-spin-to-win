...
* Bump the plugin metadata and documentation references to version 2.3.23 for release packaging.

\= 2.3.22 =
* Treat prizes without a voucher denomination as fallback outcomes so renamed "try again" slices remain available.
* Bump the plugin metadata and documentation references to version 2.3.22 for release packaging.
...
* Bump the plugin metadata and documentation references to version 2.3.19 for release packaging.
...
* Bump the plugin metadata and documentation references to version 2.3.17 for release packaging.
